...
class EditHistoryScreen extends StatefulWidget {
  EditHistoryScreen({Key? key}) : super(key: key);
...
class _EditHistoryScreenState extends State<EditHistoryScreen> {
  ...
  void getData() {
    firestore
      ...
      our_history = snapshot.get('our_history');
      historyController.text = our_history;
      setState(() {});
    });
  }
  ...
  void updateOurVision(BuildContext context) {
    showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text('Are you sure to update the (our history)'),
            actions: [
              TextButton(
                onPressed: () {
                  ...
                  firestore
                      .collection('school')
                      .doc('normal_details')
                      .update({'our_history': historyController.text});
                  Fluttertoast.showToast(
                      msg: '(Our History) updated Successfully!');
                },
                child: Text('Yes'),
              ),
              TextButton(
